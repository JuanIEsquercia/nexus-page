export const carouselImages = [
  {
    id: 1,
    url: '/images/carousel/machine_1.jpg', // Ruta relativa a la carpeta 'public'
    alt: 'Máquina automática de café en entorno corporativo',
  },
  {
    id: 2,
    url: '/images/carousel/machine_2.jpg',
    alt: 'Expendedora premium en oficina moderna',
  },
  {
    id: 3,
    url: '/images/carousel/machine_3.jpg',
    alt: 'Mantenimiento preventivo por nuestro equipo técnico',
  },
  {
    id: 4,
    url: '/images/carousel/snack_machine_1.jpg',
    alt: 'Expendedoras de snacks adicionales para grandes instalaciones',
  },
  // Instrucción para el usuario:
  // Para agregar nuevas imágenes, simplemente coloca tu foto en la carpeta public/images/carousel/
  // y añade un nuevo bloque aquí con el nombre exacto de tu archivo.
];
